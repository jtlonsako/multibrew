...
<div id="StrengthContainer" class="w-5/6 text-slate-100 place-content-center mt-10 mb-14">
    ...
    <div id="StrengthValuesContainer" class="flex flex-row justify-center mt-4">
        <button id="Light" on:click={() => selectedStrength = "Light"} class="px-10 font-extralight transition ease-in-out delay-150 {selectedStrength == "Light" ? "scale-150": "text-zinc-500 text-base mt-4"}
